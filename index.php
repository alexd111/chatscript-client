...
function displayHouses (houseList) {
  ...
  for (i = 0; i < houseList.length; i++) {
    $('#displayData').append('<h4>' + houseList[i].url + '</h4>')
    $('#displayData').append('<p> Number of bedrooms: ' + houseList[i].bedrooms + '<p>')
    $('#displayData').append('<p>Price per month: ' + houseList[i].ppm + '<p>')
